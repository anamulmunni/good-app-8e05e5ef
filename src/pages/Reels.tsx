        ...
        <div ref={playerRef} className="shrink-0 z-10" style={{ background: "#000" }}>
          <div ref={playerShellRef} className="w-full aspect-video relative overflow-hidden" style={{ background: "#000" }}>
            ...
            {selectedVideo.isExternal && isYouTubeEmbed(selectedVideo.video_url) && (
              <div className="absolute bottom-[30px] right-0 w-[200px] h-[44px] z-[5] pointer-events-none flex items-center justify-end pr-2 overflow-hidden" style={{ background: "linear-gradient(90deg, transparent 0%, #000 15%)" }}>
                <span className="text-[14px] font-black tracking-wider" style={{
