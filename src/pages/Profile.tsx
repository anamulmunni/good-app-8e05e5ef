...
import { ArrowLeft, Camera, User, Copy, Check, Pencil, X, Save, Key, Calendar, Phone, MessageCircle, Send, Headphones, ChevronDown, ChevronUp, History, Sparkles, Shield, Zap, Lock, Mail, Loader2, KeyRound } from "lucide-react";
